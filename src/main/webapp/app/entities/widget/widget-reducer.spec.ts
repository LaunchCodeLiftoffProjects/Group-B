...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './widget.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WIDGET_LIST actions', async () => {
    ...
    it('dispatches FETCH_WIDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WIDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WIDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WIDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WIDGET actions', async () => {
      const expectedActions = [
        {
