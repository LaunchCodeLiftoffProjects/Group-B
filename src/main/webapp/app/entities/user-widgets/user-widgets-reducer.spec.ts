...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERWIDGETS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERWIDGETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERWIDGETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERWIDGETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERWIDGETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERWIDGETS actions', async () => {
      const expectedActions = [
        {
